...
final class Manacost_Media_Upload_Accelerator
{
	...
	/*
	 * The upload response must only do the minimum work required to make the
	 * attachment usable in the editor. Every other rendition is generated by
	 * the retrying background worker. This avoids turning a perfectly valid
	 * PNG into WordPress' generic "server cannot process the image" error when
	 * a slow image operation happens during the HTTP upload request.
	 */
	private const DEFERRED_SIZES = [
		'medium',
		'medium_large',
		'large',
		'svl_seo_og',
	...
	/**
	 * Keep only the thumbnail synchronous for the media UI. All display and
	 * social renditions are generated by the retrying background worker.
	 *
	 * @param mixed $sizes
	 * @return mixed
	 */
