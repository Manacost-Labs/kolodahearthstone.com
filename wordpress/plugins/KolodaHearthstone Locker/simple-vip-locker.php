...
define('SVL_AUTH_BOT_URL', 'https://t.me/kolodahearthstoneauthbot');
...
require_once __DIR__ . '/svl-public-api.php';
require_once __DIR__ . '/svl-home-redesign.php';
    ...
    <div class="svl-wrapper svl-theme-<?php echo esc_attr($theme); ?>" id="<?php echo esc_attr($locker_id); ?>" data-code="<?php echo esc_attr($correct_code); ?>" data-nonce="<?php echo esc_attr($nonce); ?>" data-post-id="<?php echo esc_attr($current_post_id); ?>">
        ...
        <div class="svl-form-container svl-card">
            ...
            <div class="svl-body">
                ...
                <a
                    class="svl-bot-login"
                    href="<?php echo esc_url(SVL_AUTH_BOT_URL); ?>"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <span class="svl-brand-icon svl-brand-icon-telegram" aria-hidden="true">
                        <img src="<?php echo esc_url($ui_asset_url . 'telegram.svg'); ?>" alt="">
                    </span>
                ...
                <details class="svl-why">
                    <summary>
                        <span class="svl-why-icon" aria-hidden="true">
                            <img src="<?php echo esc_url($ui_asset_url . 'info.svg'); ?>" alt="">
                        </span>
                        <span>Почему нужна платная подписка?</span>
                    </summary>
                    <div class="svl-why-body">
                        <p>Подписка помогает команде выпускать <strong>гайды, мета-отчёты и новости</strong>, искать сильные колоды и поддерживать русскоязычное сообщество Hearthstone.</p>
                        <p class="svl-why-thanks">Спасибо, что помогаете проекту развиваться.</p>
                    </div>
                </details>
                ...
                if ($unlock_cnt >= 5): ?>
                    <div class="svl-social-proof">
                        <span class="svl-social-proof-icon" aria-hidden="true">
                            <img src="<?php echo esc_url($ui_asset_url . 'users-round.svg'); ?>" alt="">
                        </span>
                        <span>Уже разблокировали <strong><?php echo number_format_i18n($unlock_cnt); ?></strong> <?php
            ...
            function checkCode() {
                ...
                setTimeout(function(){
                    if (userVal.toLowerCase() === correctCode.toLowerCase()) {
                        ...
                        setCookie('kh_review_access_source', 'code', <?php echo intval(svl_opt('svl_cookie_days') ?: 7); ?>);
